...
public class RandomTemperatureEventGenerator {
    ...
    public void startSendingTemperatureReadings(final long noOfTemperatureEvents) {
        ...
        while (count < noOfTemperatureEvents) {
            ...
            TemperatureEvent ve = new TemperatureEvent(new Random().nextInt(500), new Date(), new Random().nextInt(500), new Random().nextInt(30), new Random().nextInt(40), true, false, false, "seg");
        
       // TemperatureEvent ve = new TemperatureEvent(new Random().nextInt(500), new Date(), 210, 22, 3, true, false, false, "seg");
